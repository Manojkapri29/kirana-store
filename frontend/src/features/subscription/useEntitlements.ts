...
export type Feature = 'barcode_lookup' | 'promotions' | 'price_intelligence' | 'advanced_reports' | 'online_store' | 'image_intelligence' | 'ai_assistant' | 'ai_insights' | 'ai_documents'
