...
export const createQuickSale = (payload: QuickSalePayload, options?: SendOptions) =>
  apiSend<QuickSale>('POST', BASE, payload, options)
...
export const postQuickSale = (id: number, payment: SalePaymentPayload, options?: SendOptions) =>
  apiSend<QuickSale>('POST', `${BASE}/${id}/post`, payment, options)
