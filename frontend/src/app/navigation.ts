...
export const NAV_ITEMS: readonly NavItem[] = [
  ...
  { id: 'online-orders', permission: 'ONLINE_ORDER_VIEW', path: '/online-orders', icon: Store, labelKey: 'nav.onlineOrders' },
  { id: 'online-store', permission: 'STORE_SETTINGS_MANAGE', path: '/online-store', icon: Globe, labelKey: 'nav.onlineStore' },
  { id: 'offline', permission: 'QUICK_SALE_CREATE', path: '/offline', icon: WifiOff, labelKey: 'nav.offline' },
  { id: 'integrations', permission: 'INTEGRATION_VIEW', path: '/integrations', icon: Plug, labelKey: 'nav.integrations' },
  { id: 'analytics', permission: 'ANALYTICS_VIEW', path: '/analytics', icon: Gauge, labelKey: 'nav.analytics' },
